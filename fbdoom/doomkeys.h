...
#define DOOM_KEYP_0          0
#define DOOM_KEYP_1          DOOM_KEY_END
#define DOOM_KEYP_2          DOOM_KEY_DOWNARROW
#define DOOM_KEYP_3          DOOM_KEY_PGDN
#define DOOM_KEYP_4          DOOM_KEY_LEFTARROW
#define DOOM_KEYP_5          '5'
#define DOOM_KEYP_6          DOOM_KEY_RIGHTARROW
#define DOOM_KEYP_7          DOOM_KEY_HOME
#define DOOM_KEYP_8          DOOM_KEY_UPARROW
#define DOOM_KEYP_9          DOOM_KEY_PGUP
